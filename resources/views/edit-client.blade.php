...
<body class="bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
        ...
        <div id="main-content" class="main-content flex-1 ml-0 md:ml-64-desktop flex flex-col">
            ...
            <header class="top-header bg-white dark:bg-gray-800 p-4 flex items-center justify-between shadow-md rounded-b-xl">
                <div class="flex items-center">
                    ...
                    <h1 class="text-2xl font-semibold ml-4">Edit Client</h1>
                </div>
    ...
    <i class="ri-lock-line mr-2"></i> Change Password
                            ...
                            <a href="#" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-b-md">
      ...
      <form id="editClientForm" method="POST" action="{{ url('/edit-client/' . $client->id) }}">
    @csrf
    @method('PUT')
    ...
    <div class="mb-6">
        ...
        >{{ old('remarks', $client->remarks) }}</textarea>
...
<script>
    Swal.fire({
        ...
        text: 'The client details have been successfully updated.',
        icon: 'success',
        showCancelButton: true,
        confirmButtonText: 'OK',
        cancelButtonText: 'View Clients',
        reverseButtons: true 
    }).then((result) => {
